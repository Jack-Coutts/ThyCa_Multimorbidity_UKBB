...
phecode_dictionary = tsv_to_df('/data/home/bt211037/dissertation/input/raw_data/ukbb_and_phec_clean.txt')
all_disease_freq = phecode_col_conversion(all_disease_freq, phecode_dictionary, 'diseases', 'FieldID', 'Field')
...
all_med_freq = phecode_col_conversion(all_med_freq, phecode_dictionary, 'diseases', 'FieldID', 'Field')
...
ThyCa_med_freq = phecode_col_conversion(ThyCa_med_freq, phecode_dictionary, 'diseases', 'FieldID', 'Field')
